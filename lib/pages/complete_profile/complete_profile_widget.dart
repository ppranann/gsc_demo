...
class _CompleteProfileWidgetState extends State<CompleteProfileWidget> {
  ...
  void initState() {
    ...
    _model.yourIntroController ??= TextEditingController();
    _model.yourIntroFocusNode ??= FocusNode();
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsetsDirectional.fromSTEB(20.0, 20.0, 20.0, 0.0),
            child: TextFormField(
              controller: _model.yourIntroController,
              focusNode: _model.yourIntroFocusNode,
              obscureText: false,
              decoration: InputDecoration(
                labelText: 'Your Introduction',
                labelStyle: FlutterFlowTheme.of(context).bodyMedium,
                hintText: 'What defines you?',
                hintStyle: FlutterFlowTheme.of(context).bodyMedium,
                enabledBorder: OutlineInputBorder(
                  borderSide: BorderSide(
                    color: Color(0x00000000),
              ...
              keyboardType: TextInputType.emailAddress,
              validator:
                  _model.yourIntroControllerValidator.asValidator(context),
            ),
          ),
          Padding(
            padding: EdgeInsetsDirectional.fromSTEB(20.0, 20.0, 20.0, 0.0),
            child: Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Your Bio',
                  labelStyle: FlutterFlowTheme.of(context).bodyMedium,
                  hintText: 'What would you say about yourself?',
                  hintStyle: FlutterFlowTheme.of(context).bodyMedium,
                  enabledBorder: OutlineInputBorder(
                    borderSide: BorderSide(
                      color: Color(0x00000000),
            ...
            child: FFButtonWidget(
              onPressed: () async {
                await currentUserReference!.update(createUsersRecordData(
                  ...
                  email: '',
                  headline: _model.yourIntroController.text,
                  bio: _model.yourBioController.text,
                  currentPosition: _model.yourTitleController.text,
                ));
